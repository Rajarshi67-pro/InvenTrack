...
import { Plus, ArrowUp, ArrowDown, RefreshCw, Search } from 'lucide-react';
  ...
  useEffect(() => {
    api.get('/inventory/movements')
      .then(r => {
        ...
        if (Array.isArray(d) && d.length) setMovements(d);
      })
      .catch(() => {});
  }, []);
    ...
    >
      ...
      <div className="page-header">
        ...
        <div className="flex gap-3">
          <button className="btn-secondary" onClick={() => setShowStockIn(false)}>
        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-gray-400 mb-1.5">Product SKU</label>
                <input
            ...
            <div className="flex gap-3 mt-5">
              <button className="btn-secondary flex-1 justify-center" onClick={() => setShowStockIn(false)}>
                Cancel
              </button>
              <button className="btn-primary flex-1 justify-center" onClick={handleStockIn}>
                <Plus className="w-4 h-4" />
                Record
              </button>
            </div>
